...
import com.wineshop.service.SupplierService;
...
public class AdminProductController {
	...
	public String product_form(ModelMap model, @Validated @ModelAttribute("product") Product product, BindingResult errors,
		...
		if (photo.isEmpty()) {
			...
			try {
				photo.transferTo(new File("C:\\Users\\DELL\\Downloads\\WineSalingShop\\src\\main\\webapp\\resources\\images\\" + photo.getOriginalFilename()));
				product.setUrl("resources/images/" +photo.getOriginalFilename());
	...
	public String editProduct(ModelMap model, @Validated @ModelAttribute("product") Product product, BindingResult errors,
			@RequestParam("photo") MultipartFile photo, HttpServletRequest request) {
		if(errors.hasErrors()){
			return "admin/product_update";
		}
